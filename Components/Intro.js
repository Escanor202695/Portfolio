...
function Intro(props) {
  ...
  return (
    <div className="relative w-100 h-[30rem] md:h-[55vw] 2xl:h-[50vw]">
      <div
        className="w-full h-full bg-cover text-transparent"
      ...
      >
        ...
        <div className="flex flex-col flex-[.8] h-[22rem] md:h-auto justify-center items-center drop-shadow-md">
          <div className="signature text-white z-20 mb-3 text-[10vw] md:text-[5vw] drop-shadow-md">
            Sakib Chowdhury
          </div>
          <div
          ...
          >
            {" "}
            I&apos;m a<span className="text-theme drop-shadow-md">&nbsp;frontend&nbsp;</span>
            developer
          </div>
        </div>
      </div>
